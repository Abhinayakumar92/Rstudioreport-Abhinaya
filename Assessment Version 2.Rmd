...
The data obtained has mainly the numbers of hospitilisations and rates for the given years. This data does not allow any causal inference, as no other factors are mentioned.Also, since it is secondary data, there is no control over the quality and the methodology of obtaining it.

The strengths of the summary statistics are that it is easy to interpret, and gives a clear snapshot of the mean hospitalisation cases in the period. The limitation is that there is no data on the variation during individual years. The strength of the bar chart is that it is easy to interpret and clearly shows the difference in the rates over the years. THe limitation is that since we are considering 3-year rolling averages, it is difficult to track individual year rates and plot it on a trend line, due to the overlap.
