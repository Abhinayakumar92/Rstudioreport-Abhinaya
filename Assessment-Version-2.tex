...
\urlstyle{same}
\hypersetup{
  pdftitle={Assessment Version 2},
  pdfauthor={Abhinaya},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Assessment Version 2}
\author{Abhinaya}
\date{2025-12-01}
...
The data obtained has mainly the numbers of hospitilisations and rates
...
during individual years. The strength of the bar chart is that it is
easy to interpret and clearly shows the difference in the rates over the
years. THe limitation is that since we are considering 3-year rolling
averages, it is difficult to track individual year rates and plot it on
a trend line, due to the overlap.
...
\subsubsection{Plot a bar chart of hospitalisation
rate}\label{plot-a-bar-chart-of-hospitalisation-rate}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assessment-Version-2_files/figure-latex/bar-chart-1.pdf}}

\subsection{Interpretation}\label{interpretation}

The bar chart shows a steady decline in the hospitalisation rates of
coronary heart disease, from the years 2017-2022, depicted by the 3 year
rolling averages seen in the bar graph.
